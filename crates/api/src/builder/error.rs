...
impl IntoResponse for BuilderApiError {
    fn into_response(self) -> Response {
        match self {
            ...
            BuilderApiError::InvalidWithdrawlsRoot => (StatusCode::BAD_REQUEST, "invalid withdrawals root").into_response(),
            BuilderApiError::MissingWithdrawlsRoot => (StatusCode::BAD_REQUEST, "missing withdrawals root").into_response(),
